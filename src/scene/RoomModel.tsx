    ...
    <group dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={0.913}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          ...
          {/* ── Profile: ベッド ── */}
          <InteractiveObject sectionId="profile" ariaLabel="プロフィールを見る">
          ...
          {/* ── Skills: PCケース ── */}
          <InteractiveObject sectionId="skills" ariaLabel="スキルを見る">
          ...
          {/* ── Works: モニター ── */}
          <InteractiveObject sectionId="works" ariaLabel="制作物を見る">
          ...
          {/* ── Contact: 本 ── */}
          <InteractiveObject sectionId="contact" ariaLabel="コンタクトを見る">
